...
class NaturalMonumentTableExtractor(DefaultWikipediaTableExtractor):

    def __init__(self):
        table_structure = [("id_no", WikipediaTableCellType.TEXT),
        ...
        super(NaturalMonumentTableExtractor, self).__init__(table_structure)
